...
email_yes = True
condition_for_email = 0
def intro_two(answer, conditions):
    user_answer = answer
    condition_for_email = conditions
    if user_answer == 'Y':
        condition_for_email += 0
    elif user_answer == 'N':
        condition_for_email += 1
    else:
        print('ERROR! Invalid Input. Try again.')
        intro_two(input('Before we start, would you like to provide your email so that we can notify you about '
...
input('Ok, press ENTER to start the quiz. Good luck!')
